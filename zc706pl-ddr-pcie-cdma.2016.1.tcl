...
set mig_file [file join $script_folder zc706-mig.prj]
...
if { $list_projs eq "" } {
   ...
   create_project $project_name myproj -part xc7z045ffg900-2
...
# Defaults not used in kintex design
...
#CONFIG.M_AXI_DATA_WIDTH.VALUE_SRC {DEFAULT} \
#CONFIG.S_AXI_DATA_WIDTH.VALUE_SRC {DEFAULT}] $axi_pcie_1
...
proc create_root_design { parentCell  proj_name design_name migfile} {
  ...
  create_bd_addr_seg -range 1G  -offset 0x40000000 [get_bd_addr_spaces /pcie_cdma_subsystem/axi_cdma_1/Data] [get_bd_addr_segs /ddr3_mem/memmap/memaddr] DMA_2_Ddr3
  ...
  create_bd_addr_seg -range 1G  -offset 0x40000000 [get_bd_addr_spaces /pcie_cdma_subsystem/axi_cdma_1/Data_SG] [get_bd_addr_segs /ddr3_mem/memmap/memaddr] DMAsg_2_Ddr3
  ...
  create_bd_addr_seg -range 1G  -offset 0x40000000 [get_bd_addr_spaces /pcie_cdma_subsystem/axi_pcie_1/M_AXI] [get_bd_addr_segs /ddr3_mem/memmap/memaddr] PCIe_2_Ddr3
